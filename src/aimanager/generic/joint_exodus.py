...
16.1% (``notes/autoresearch_log/switch-exodus-k-onehot.md`` notes 3-5, on the
``auto/switch-exodus-k-onehot`` branch; ported here by
``notes/autoresearch_log/switch-kexo-port.md``).
