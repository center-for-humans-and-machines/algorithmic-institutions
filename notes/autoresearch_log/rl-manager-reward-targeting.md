...
**What this means for the programme.** This branch removes the incentive explanation from contention, and it joins a row of negatives rather than starting one. The exploration arms that have reported are PR #212 (annealed local epsilon-greedy — "gap closed, shape not recovered") and PR #214 (evolution strategies — "no contingency, in any seed, in either direction"); neither recovered the shape. Now the reward has been changed and the shape has not followed either. Exploration and incentive were the two standing explanations and both have been tested and found wanting, which pushes the cause toward the learning dynamics or the environment — the credit assignment through a 24-round episode with a moving membership, the value function's treatment of a delayed benefit, or the world model itself.
...
4. **The claim about the exploration programme is an inference across branches.** PRs #212 and #214 are read from their titles and the brief's summary; neither was re-run or re-verified here, and two further arms (#213 bootstrapped DQN, #216 parameter-space noise) had not reported when this was written. "Both standing explanations have been tested" is therefore a statement about the arms that have reported, not about the programme's full result.
